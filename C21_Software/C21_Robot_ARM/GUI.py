...
theta1 = pi/2 # initial upper angle (from vertical)
...
while True:
    ...
    bar1.rotate( angle=0, axis=vec(0,0,1), origin=pivot1 )
    bar1b.rotate( angle=0, axis=vec(0,0,1), origin=pivot1 )
    pivot2 = vec(axle2.pos.x, axle2.pos.y, pivot1.z)
    axle2.rotate( angle=0, axis=vec(0,0,1), origin=pivot1 )
    bar2.rotate( angle=0, axis=vec(0,0,1), origin=pivot2 )
    pivot2 = vec(axle2.pos.x, axle2.pos.y, pivot1.z)
